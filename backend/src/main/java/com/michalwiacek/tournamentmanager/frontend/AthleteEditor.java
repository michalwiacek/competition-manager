...
import com.vaadin.ui.themes.ValoTheme;
    ...
    @SpringComponent
    @UIScope
    public class AthleteEditor extends VerticalLayout {
        ...
        Binder<Athlete> binder = new Binder<>(Athlete.class);

        @Autowired
        public AthleteEditor(AthleteRepository repository) {
            ...
            save.addClickListener(e -> repository.save(athlete));
            delete.addClickListener(e -> repository.delete(athlete));
            cancel.addClickListener(e -> editAthlete(athlete));
            setVisible(false);
        }
        ...
        public final void editAthlete(Athlete a) {
            if (a == null) {
                setVisible(false);
                return;
            }
            ...
            if (persisted) {
                ...
                //athlete = repository.findOne(a.getId());
            }
            else {
                athlete = a;
            }
